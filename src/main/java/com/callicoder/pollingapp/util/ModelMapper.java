package com.callicoder.pollingapp.util;

import com.callicoder.pollingapp.model.Poll;
import com.callicoder.pollingapp.model.User;
import com.callicoder.pollingapp.payload.ChoiceResponse;
import com.callicoder.pollingapp.payload.PollResponse;
import com.callicoder.pollingapp.payload.UserSummary;
...
public class ModelMapper {
    ...
    public static PollResponse mapPollToPollResponse(Poll poll, Map<Long, Long> choiceVoteMap, User creator, Long userVote) {
        ...
        if (userVote != null) {
            pollResponse.setSelectedChoices(userVote);
        }
